...
function initCompanyRouters()
{
    ...
    router.get("/company_exists_by_id/:company_id",controller.companyController.createCompanyExistController)
    router.get("/company_name/:company_id",controller.companyController.createGetCompanyNameByCompanyIdController)
    router.get("/company_email/:company_id",controller.companyController.createGetCompanyEmailByCompanyIdController)
